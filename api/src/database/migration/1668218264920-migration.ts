...
export class migration1668218264920 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`date\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`value\` int NOT NULL, \`seller\` varchar(255) NOT NULL, \`signal\` tinyint NOT NULL DEFAULT 1, \`typeId\` int NULL, \`fileImportId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    )
    await queryRunner.query(
